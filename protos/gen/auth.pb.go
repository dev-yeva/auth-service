...
const file_api_auth_proto_rawDesc = "" +
	"\n" +
	"\x0eapi/auth.proto\x12\x03api\x1a\x1bbuf/validate/validate.proto\"j\n" +
	"\x0fRegisterRequest\x12 \n" +
	"\x05email\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x18\xc0\x02`\x01R\x05email\x125\n" +
	"\bpassword\x18\x02 \x01(\tB\x19\xbaH\x16r\x14\x10\f\x18H2\x0e^[\\x20-\\x7E]+$R\bpassword\"+\n" +
	"\x10RegisterResponse\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\"~\n" +
	"\fLoginRequest\x12 \n" +
	"\x05email\x18\x01 \x01(\tB\n" +
	"\xbaH\ar\x05\x18\xc0\x02`\x01R\x05email\x125\n" +
	"\bpassword\x18\x02 \x01(\tB\x19\xbaH\x16r\x14\x10\f\x18H2\x0e^[\\x20-\\x7E]+$R\bpassword\x12\x15\n" +
	...
	"\aIsAdmin\x12\x13.api.IsAdminRequest\x1a\x14.api.IsAdminResponseB\aZ\x05.;genb\x06proto3"
